...
export const projects: Project[] = [
  {
    ...
    shortDescription: '20kW residential solar installation with 40kWh battery storage, engineered for complete energy independence and 85% grid reduction.',
  ...
  },
  {
    ...
    clientType: 'Residential',
    shortDescription: '15kW residential solar system with 30kWh battery storage, engineered for 75% electricity cost reduction and 24/7 power availability.',
